define([], function() {
	...
	function buildBarChart(id, dataUrl, selectedTeam, yAxisName, xAxisName) {
	...
	return {
		...
		//Wraps buildTable for other modules to use.
		buildSeasonTable: function(teamData) {
			buildTable(teamData);
		},
		
		//Wraps buildBarChart for other modules to use.
		buildBar: function(id, dataUrl, selectedTeam, yAxisName, xAxisName) {
			buildBarChart(id, dataUrl, selectedTeam, yAxisName, xAxisName);
		}
	};
});